...
setup(
    name="LabletGeneralizationBenchmark",
    version="1.0",
    ...
    #
    # 1. Create the function you want to run on the CLI in src/lablet_generalization_benchmark/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/LabletGeneralizationBenchmark (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # LabletGeneralizationBenchmark = lablet_generalization_benchmark.cli:main
    # """,
    #
